...
#define LCD_CS 9 // Chip Select goes to Analog 3
#define LCD_CD 10 // Command/Data goes to Analog 2
#define LCD_WR 11 // LCD Write goes to Analog 1
#define LCD_RD 12 // LCD Read goes to Analog 0
