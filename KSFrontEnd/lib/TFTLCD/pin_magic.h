...
#define DELAY7 delayNanoseconds(400)
...
#define RD_ACTIVE digitalWrite(rdPin, LOW)
#define RD_IDLE digitalWrite(rdPin, HIGH)
#define WR_ACTIVE digitalWrite(wrPin, LOW)
#define WR_IDLE digitalWrite(wrPin, HIGH)
#define CD_COMMAND digitalWrite(cdPin, LOW)
#define CD_DATA digitalWrite(cdPin, HIGH)
#define CS_ACTIVE digitalWrite(csPin, LOW)
#define CS_IDLE digitalWrite(wrPin, HIGH)
#else
// When using the TFT breakout board, control pins are configurable.
